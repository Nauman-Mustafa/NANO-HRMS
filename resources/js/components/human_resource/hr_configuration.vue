            ...
            <div class="content-wrapper container-xxl p-0">
                ...
                <div class="content-body">
                    <section class="app-user-view-account">
                        <div class="hrconfigurationrow">
                            <div class="headingrow">
                                <h3 class="hrcontrolerheading">
                                    HR Configuration
                                </h3>
                            </div>

                            <div class="row my-4 mx-4">
                                <div class="col-md-6 col-sm-3 mb-1">
                                    <label
                                        class="form-label hrconfigrationentries"
                                        for="accountFirstName"
                                        >Gratuty Start From (Days)</label
                                    >
                                    <label style="color: #d93025">*</label>
                                    <input
                                        type="number"
                                        class="form-control hrconfigurationinput"
                                        id="accountFirstName"
                                        v-model="gratuty_start"
                                    />
                                    <span
                                        style="color: #db4437; font-size: 11px"
                                        v-if="this.gratuty_start == ''"
                                        >{{ e_gratuty_start }}</span
                                    >
                                </div>
                                <div class="col-md-6 col-sm-3 mb-1">
                                    <label
                                ...
                                <div class="col-md-6 col-sm-3 mb-1">
                                    ...
                                    <input
                                        ...
                                        class="form-control hrconfigurationinput"
                                        id="accountFirstName"
                                        v-model="days_deduction"
                                    />
                                    <span
                                        style="color: #db4437; font-size: 11px"
                                        v-if="this.days_deduction == ''"
                                        >{{ e_days_deduction }}</span
                                    >
                                </div>
                                <div class="col-md-6 col-sm-3 mb-1">
                                    <label
                                ...
                                <div class="col-md-6 col-sm-3 mb-1">
                                    ...
                                    <input
                                        ...
                                        class="form-control hrconfigurationinput"
                                        id="accountFirstName"
                                        v-model="annual_leaves"
                                    />
                                    <span
                                        style="color: #db4437; font-size: 11px"
                                        v-if="this.annual_leaves == ''"
                                        >{{ e_annual_leaves }}</span
                                    >
                                </div>
                                <div class="col-md-6 col-sm-3 mb-1">
                                    <label
                                        class="form-label hrconfigrationentries"
                                        for="accountFirstName"
                                        >Sick Leaves (per fiscal year)</label
                                    >
                                    <label style="color: #d93025">*</label>
                                    <input
                                        type="number"
                                ...
                                <div class="col-md-6 col-sm-3 mb-1">
                                    <label
                                        class="form-label hrconfigrationentries"
                                        for="accountFirstName"
                                        >Casual Leaves (per fiscal year)</label
                                    >
                                    <label style="color: #d93025">*</label>
                                    <input
                                        type="number "
                                        class="form-control hrconfigurationinput"
                                        id="accountFirstName"
                                        v-model="casual_start"
                                    />
                                    <span
                                        style="color: #db4437; font-size: 11px"
                                        v-if="this.casual_start == ''"
                                        >{{ e_casual_start }}</span
                                    >
                                </div>
                                <div
                                    class="col-md-4 col-sm-3 mb-1"
                                ...
                                >
                                    <button
                                        ...
                                        @click="delay3()"
                                        style="width: 100%"
                                        class="btn hrconfigurationbutton me-1 mt-1"
                                    >
                                        Update
                                    </button>
                                </div>
                        ...
                        <div class="sessiondetailrow">
                            <div class="headingrow">
                                <h3 class="hrcontrolerheading">
                                    Session Detail
                                </h3>
                            </div>
                            <div class="sessiontabeldiv">
                                <table class="sessiondetailtabel">
                                <thead class="py-3">
                                    <tr>
                                        <th class="sessiontabel-th">Session Name</th>
                                        <th class="sessiontabel-th">Start</th>
                                        <th class="sessiontabel-th">End</th>
                                        <th class="sessiontabel-th">Status</th>
                                        <th class="sessiontabel-th">Action  </th>
                                    </tr>
                                </thead>
                                <tbody>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    >
                                                                                        <a
                                                                                            v-if="
                                                                                                adsdata1.AttClosedPayrollStart ==
                                                                                                'Open'
                                                                                            "
                                                                                        >
                                                                                            <span
                            ...
                            <div class="d-flex align-item-center justify-content-center"   style=" text-align: center;  padding-top: 20px; " >
                                                                    <pagination
                                                                        :data="
                                                                            adsdata
                                                                        "
                        ...
                        <div class="sessiondetailrow">
                            ...
                            <div class="sessiontabeldiv">
                                ...
                                <thead class="py-3">
                                    <tr>
                                        <th class="sessiontabel-th">Holiday Name</th>
                                        <th class="sessiontabel-th">Start</th>
                                        <th class="sessiontabel-th">End</th>
                                        <th class="sessiontabel-th">No.of days</th>
                                        <th class="sessiontabel-th">Actions</th>
                                ...
                                <tbody>
                                    ...
                                    <tr
                                                                            ...
                                                                            >
                                                                                <td>
                                                                                    {{
                                                                                        holiday_data1.HolidayName
                                                                                    }}
                                                                                </td>
                                                                                <td>
                                                                                    {{
                                                                                        holiday_data1.holidaystartDate
                                                                                    }}
                                                                                </td>
                                                                                <td>
                                                                                    {{
                                                                                        holiday_data1.HolidayEndDate
                                                                                    }}
                                                                                </td>
                                                                                <td>
                                                                                    {{
                                                                                        holiday_data1.NoOfDays
                                                                                    }}
                                                                                </td>
                                                                                <td>
                                                                                    <a
                                                                                        v-if="
                                                                                            hasPermission(
                                                                                                'HR Controller delete holiday'
                                                                                            )
                                                                                        "
                                                                                        @click="
                                                                                            delete_holiday(
                                                                                                holiday_data1.HolidayID
                                                                                            )
                                                                                        "
                                                                                        class="me-25"
                                                                                    >
                            ...
                            <div v-if="!holiday_data.data || holiday_data.data.length === 0" class="empty-message">
        EMPTY
    </div>
                            <div class="buttonrow">
    <div class="col-md-3 offset-md-0"> 
        <button v-if="hasPermission('HR Controller inchlude holiday')"
                data-bs-toggle="modal"
                data-bs-target="#addNewCard"
                class="btn btn-outline-primary waves-effect w-100">+ Include Holiday</button>
    </div>
</div>
                            </div>
                        ...
                        <div class="sessiondetailrow">
                                ...
                                <tbody>
                                    ...
                                    <tr
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <td>
                                                                                {{
                                                                                    finedetail1.FineSession
                                                                                }}
                                                                            </td>
                                                                            <td>
                                                                                {{
                                                                                    finedetail1.FineAmount
                                                                                }}
                                                                            </td>
                                                                            <td>
                                                                                {{
                                                                                    finedetail1.FineDate
                                                                                }}
                                                                            </td>
                                                                            <td>
                                                                                {{
                            ...
                            <div v-if="!finedetail.data || finedetail.data.length === 0" class="empty-message">
        EMPTY
    </div>
                            <div class="buttonrow">
    <div class="col-md-3 offset-md-0"> <!-- Adjusted grid classes for centering -->
        <button   v-if="   hasPermission( 'HR Controller add new fine'
                                                                    )
                                                                "
                                                                data-bs-toggle="modal"
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            >
                                                                                <td>
                                                                                    {{
                                                                                        warning_reason1.ReasonName
                                                                                    }}
                                                                                </td>
                                                                                <td
                                                                                    v-html="
                                                                                        warning_reason1.ReasonContent
                                                                                    "
                                                                                ></td>
                        ...
                        <div class="row">
                            ...
                            >
                                <div
                                    class="modal-dialog modal-md modal-dialog-centered modal-edit-user"
                                >
                                    <div class="modal-content">
                                        ...
                                        <div
                                            class="modal-body pb-5 px-sm-5 pt-50"
                                        >
                                            <form
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <td>
                                                                                    <a
                                                                                        v-if="
                                                                                            hasPermission(
                                                                                                'HR Controller delete leave type'
                                                                                            )
                                                                                        "
                                                                                        @click="
                                                                                            delete_leave(
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            ...
                            <h5>
                                Do you want to Close this session and move
                                employees attendance to payroll?
                            </h5>
                            <div class="text-center" style="text-align: center">
                                <button
                                    type="button"
                                    @click="update_session_payroll()"
...
export default {
    ...
    methods: {
        update_Warning() {
            axios
                ...
                .then((data) => {
                    ...
                    const updatedIndex = this.warning_reason.data.findIndex(
                        (item) => item.ReasonID === this.warn_id
                    );
                    if (updatedIndex !== -1) {
                        this.warning_reason.data[updatedIndex].ReasonName =
                            this.edit_warning_reason;
                        this.warning_reason.data[updatedIndex].ReasonContent =
                            this.edit_warning_description;
        ...
        Edit_warn_reason(id) {
            axios.get("get_warningreason_byId/" + id).then((response) => {
                console.log(
                    "warning reason by id ",
                    response.data[0].ReasonContent
                );
            ...
            axios
                ...
                .then((response) => {
                    if (response.data == "session closed") {
                        this.getResult();
                        this.$toastr.s(
                            "Session Closed and Salaries process started!",
                            "Information!"
                        );
                    }
                });
        ...
        submit_configuration() {
            if (
                ...
                this.$toastr.e(
                    "All fields required to update Configuration!",
                    "Warning"
                );
            } else {
                axios
        ...
        submit_holiday() {
            if (!this.h_date_to == "") {
                if (this.h_date_to < this.h_date_from) {
                    this.$toastr.e(
                        "Date To cannat be smaller then Date From!",
                        "Caution!"
                    );
                }
            }
        ...
        delete_warn_reason(id) {
            axios
                .get("delete_warn_reas/" + id)
                .then((response) => {
                    this.$toastr.s(
                        "Warning Reason Deleted Successfully!",
                        "Deleted"
                    );
